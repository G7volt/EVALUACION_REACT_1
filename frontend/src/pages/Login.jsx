...
//Lista de Users falsos para prueba
const users = [
    { id: 1, email: "user1@example.com", userName: "user1", password: "123456789" },
    { id: 2, email: "user2@example.com", userName: "user1", password: "er4567uv" },
    { id: 3, email: "user3@example.com", userName: "user1", password: "tv3456YEW" }
];
...
const login = () => {
    ...
    <div className="min-h-screen bg-slate-50 px-4 py-10 sm:px-6 lg:px-8 flex items-center justify-center">
        <div className="mx-auto flex w-full max-w-6xl flex-col gap-8 rounded-4xl bg-[#9FC9FF] p-6 shadow-xl shadow-slate-200/50 md:p-10 md:flex-row md:items-center">
            <div className="w-full">
            <div className="max-w-M">
                <h1 className="text-3xl font-bold text-slate-700 sm:text-4xl">Inicia sesión</h1>
            </div>
